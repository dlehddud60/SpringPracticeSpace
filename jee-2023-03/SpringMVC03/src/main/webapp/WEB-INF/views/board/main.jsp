    ...
    <script>
        ...
        function makeView(data) {
            ...
            $.each(data,function (index,obj){
                ...
                listHtml+="<textarea id='ta"+obj.idx+"' readonly rows='7' class='form-control'면></textarea>";
        ...
        <div class="panel-body" id="wfrom" style="display: none">
            ...
            <form id="frm">
                ...
                <table class="table">
                    ...
                    <tr>
                        <td>내용</td>
                        <td><textarea name="content" id="content" class="form-control" rows="7"></textarea></td>
                    </tr>
